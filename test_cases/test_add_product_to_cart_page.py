...
class Test_product_page():
    ...
    def test_add_to_cart(self,setup):
        self.logger.info("********product add to cart test case strted*********")
        self.driver = setup
        ...
        self.logger.info("********sucessfully log in to the account*********")
        ...
        self.logger.info("********product add to cart test case finished*********")
